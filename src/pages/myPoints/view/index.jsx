            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <div className="tableWrap">
                        ...
                        {/* <DataTable
                            id="mypointsHistory" className="historyTable display stripe cell-border"
                            data={tableData}
                            onSelect={(e, api, type, indexes) => {console.log(e, type, indexes)}}
                            onDeselect={(e, api, type, indexes) => {console.log(e, type, indexes)}}
                            options={{
                                columnDefs: [
